...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_24m93 -lang vhdl -synth lse -arch se5c00 -type pll -fin 8.31 -fclkop 25 -fclkop_tol 0.5 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock -sticky 
...
architecture Structure of pll_24m93 is
...
-- synopsys translate_off
library MachXO3D;
configuration Structure_CON of pll_24m93 is
    for Structure
