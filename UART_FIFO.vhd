...
-- Module  Version: 5.8
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n UART_FIFO -lang vhdl -synth lse -bus_exp 7 -bb -arch se5c00 -type ebfifo -depth 256 -width 8 -rwidth 8 -no_enable -pe 10 -pf 120 -sync_reset 

-- Thu Mar 05 08:49:31 2026
...
begin
    ...
    UART_FIFO_0_0: FIFO8KB
        ...
        AFPOINTER1=> "0b00011101110000", AFPOINTER=> "0b00011110000000", 
...
configuration Structure_CON of UART_FIFO is
    for Structure
        ...
        for all:FIFO8KB use entity MachXO3D.FIFO8KB(V); end for;
    end for;
end Structure_CON;
